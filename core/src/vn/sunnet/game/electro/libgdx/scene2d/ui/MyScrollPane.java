package vn.sunnet.game.electro.libgdx.scene2d.ui;
...
//				getStage().setScrollFocus(MyScrollPane.this);
//
...
//				
//				anchor = getScrollX();
//				System.out.println("touchDown"+ total);
//
...
//				if (pointer != draggingPointer) return;
//				System.out.println("touchDragged"+ total);
//				if (touchScrollH) {
...
//				System.out.println("+++++++++++++"+amountX+" "+Math.abs(getScrollX() - anchor));
//				resetFade();
//				if (Math.abs(getScrollX() - anchor) < page)
//				amountX -= deltaX;
//				else {
//					setScrollX(getScrollX() > anchor?anchor + page: anchor - page);
//				}
//				amountY += deltaY;
//				clamp();
